...
by a unique substring of its headline, so no URL is typed by hand. Paid For's and the Ballroom's
are `scripts/build-paid-for.cjs` and `scripts/build-the-ballroom.cjs`: edit them and regenerate
